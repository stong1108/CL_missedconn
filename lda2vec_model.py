...
class LDA2Vec(Chain):
    def __init__(self, n_cities=100, n_city_topics=10,
                 n_categories=100, n_category_topics=10,
                 n_units=256, n_vocab=1000, dropout_ratio=0.5, train=True,
                 counts=None, n_samples=15, word_dropout_ratio=0.0):
        em1 = EmbedMixture(n_cities, n_city_topics, n_units,
                           dropout_ratio=dropout_ratio)
        em2 = EmbedMixture(n_categories, n_category_topics, n_units,
                           dropout_ratio=dropout_ratio)
        kwargs = {}
